...
public class SepaController {
    ...
    @Operation(summary = SwaggerConstants.SEPA_VALIDATE_SUMMARY,
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    required = true,
                    content = {
                            @Content(mediaType = "application/xml", examples = @ExampleObject(value = SwaggerConstants.SEPA_VALIDATE_REQUEST_EXAMPLE_VALID), schema = @Schema(implementation = SwaggerConstants.SwaggerSepaPacs008Wrapper.class))
                    }),
            responses = {
                    @ApiResponse(
                            responseCode = "200",
