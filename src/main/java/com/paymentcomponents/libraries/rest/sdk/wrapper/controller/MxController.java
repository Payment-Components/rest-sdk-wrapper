    ...
    @Operation(summary = SwaggerConstants.MX_VALIDATE_SUMMARY,
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            headers = @Header(name = Constants.REQUEST_LOG_ID, description = SwaggerConstants.REQUEST_LOG_ID_DESCRIPTION),
                            content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SwaggerConstants.MX_VALIDATE_RESPONSE_EXAMPLE_400), array = @ArraySchema(schema = @Schema(implementation = ValidationError.class)))),
                    @ApiResponse(
                            responseCode = "500",
