...
public class MtController {
    ...
    @Operation(summary = SWIFT_MT_CREATE_103_SUMMARY,
            description = SWIFT_MT_CREATE_103_DESCRIPTION,
            tags = SWIFT_MT_TAG,
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = VALID_MESSAGE_DESCRIPTION,
                            headers = @Header(name = REQUEST_LOG_ID, description = REQUEST_LOG_ID_DESCRIPTION),
                            content = @Content(mediaType = "text/plain", examples = @ExampleObject(value = SWIFT_MT_CREATE_103_RESPONSE_EXAMPLE_200))),
                    @ApiResponse(
                            responseCode = "400",
                            description = INVALID_MESSAGE_DESCRIPTION,
                            headers = @Header(name = REQUEST_LOG_ID, description = REQUEST_LOG_ID_DESCRIPTION),
    ...
    @Operation(summary = SWIFT_MT_CREATE_GENERAL_SUMMARY,
            description = SWIFT_MT_CREATE_GENERAL_DESCRIPTION,
            tags = SWIFT_MT_TAG,
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = VALID_MESSAGE_DESCRIPTION,
                            headers = @Header(name = REQUEST_LOG_ID, description = REQUEST_LOG_ID_DESCRIPTION),
                            content = @Content(mediaType = "text/plain", examples = @ExampleObject(value = SWIFT_MT_CREATE_GENERAL_RESPONSE_EXAMPLE_200))),
                    @ApiResponse(
                            responseCode = "400",
                            description = INVALID_MESSAGE_DESCRIPTION,
                            headers = @Header(name = REQUEST_LOG_ID, description = REQUEST_LOG_ID_DESCRIPTION),
    ...
    @Operation(summary = SWIFT_MT_GENERATE_UNIVERSAL_CONFIRM_SUMMARY,
            description = SWIFT_MT_GENERATE_UNIVERSAL_CONFIRM_DESCRIPTION,
            tags = SWIFT_MT_TAG,
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    required = true,
                    content = {
                            @Content(mediaType = "text/plain", examples = @ExampleObject(value = SWIFT_MT_GENERATE_UNIVERSAL_CONFIRM_REQUEST_EXAMPLE_VALID))
                    }),
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = VALID_MESSAGE_DESCRIPTION,
                            headers = @Header(name = REQUEST_LOG_ID, description = REQUEST_LOG_ID_DESCRIPTION),
                            content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SWIFT_MT_GENERATE_UNIVERSAL_CONFIRM_RESPONSE_EXAMPLE_200), schema = @Schema(implementation = CustomSwiftMessage.class))),
                    @ApiResponse(
                            responseCode = "400",
                            description = INVALID_MESSAGE_DESCRIPTION,
                            headers = @Header(name = REQUEST_LOG_ID, description = REQUEST_LOG_ID_DESCRIPTION),
                            content = @Content(mediaType = "application/json", examples = @ExampleObject(value = SWIFT_MT_GENERATE_UNIVERSAL_CONFIRM_RESPONSE_EXAMPLE_400))),
                    @ApiResponse(
                            responseCode = "500",
                            description = UNHANDLED_ERROR_DESCRIPTION,
                            headers = @Header(name = REQUEST_LOG_ID, description = REQUEST_LOG_ID_DESCRIPTION),
