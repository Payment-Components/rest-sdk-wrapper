...
public class MtServiceTest {
    ...
    public void givenValidMtMessage_whenMtParse_thenReturnCustomSwiftMessageObject() throws Exception {
        ...
        //WHEN
        CustomSwiftMessage customSwiftMessage = mtService.parseMt(TestConstants.VALID_MT_103);
    ...
    @Test
    public void givenInvalidFormatMtMessage_whenMtParse_thenThrowInvalidMessageFormatException() throws Exception {
        //GIVEN
        String mtMessage = TestConstants.VALID_MT_103.replace("{1:", "");
    ...
    @Test
    public void givenValidMtMessage_whenMtValidate_thenDoNothing() throws Exception {
        //GIVEN

        //WHEN
        assertDoesNotThrow(() -> mtService.validateMt(TestConstants.VALID_MT_103));

        //THEN
    }

    @Test
    public void givenInvalidMtMessage_whenMtValidate_thenThrowInvalidMessageException() throws Exception {
        //GIVEN
        ...
        InvalidMessageException exception = assertThrows(InvalidMessageException.class, () -> {
            mtService.validateMt(TestConstants.INVALID_MT_103);
        });
    ...
    @Test
    public void givenInvalidFormatMtMessage_whenMtValidate_thenThrowInvalidMessageFormatException() throws Exception {
        //GIVEN
        String mtMessage = TestConstants.VALID_MT_103.replace("{1:", "");
